...
Add-WindowsFeature -Name Web-Common-Http,Web-Http-logging,Web-Custom-Logging,Web-Log-Libraries,Web-Request-Monitor,Web-Http-Tracing,Web-Performance,Web-Filtering,Web-ASP-Net,Web-ASP-Net45,Web-FTP-Server,Web-Mgmt-Console,Web-Scripting-Tools,Web-Mgmt-Service -IncludeAllSubFeature
...
cmd.exe /c $LocalTime
$SetFlags = "Date,Time,ClientIP,UserName,SiteName,ComputerName,ServerIP,Method,UriStem,FtpStatus,Win32Status,BytesSent,BytesRecv,TimeTaken,ServerPort,Host,FtpSubStatus,Session,FullPath,Info,ClientPort"
Set-ItemProperty "IIS:\Sites\Default FTP Site" -Name ftpServer.logfile.logExtFileFlags -Value $SetFlags
